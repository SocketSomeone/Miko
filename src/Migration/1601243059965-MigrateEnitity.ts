...
export class MigrateEnitity1601243059965 implements MigrationInterface {
	name = 'MigrateEnitity1601243059965';

	public async up(queryRunner: QueryRunner): Promise<void> {
		await queryRunner.query(`ALTER TABLE "base_guild" DROP COLUMN "permissions"`);
		await queryRunner.query(`ALTER TABLE "base_guild" DROP COLUMN "punishmentConfig"`);
		await queryRunner.query(`ALTER TABLE "base_settings" ADD "permissions" json NOT NULL DEFAULT '[]'`);
	...
	public async down(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(`ALTER TABLE "base_settings" DROP COLUMN "permissions"`);
		await queryRunner.query(`ALTER TABLE "base_guild" ADD "punishmentConfig" json NOT NULL DEFAULT '[]'`);
		await queryRunner.query(`ALTER TABLE "base_guild" ADD "permissions" json NOT NULL DEFAULT '[]'`);
	}
}
