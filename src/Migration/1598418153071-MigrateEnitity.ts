...
export class MigrateEnitity1598418153071 implements MigrationInterface {
	name = 'MigrateEnitity1598418153071';

	public async up(queryRunner: QueryRunner): Promise<void> {
		await queryRunner.query(`ALTER TABLE "base_guild" ADD "banReason" character varying`);
	...
	public async down(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(`ALTER TABLE "base_guild" DROP COLUMN "banReason"`);
	}
}
