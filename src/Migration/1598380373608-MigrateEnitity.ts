...
export class MigrateEnitity1598380373608 implements MigrationInterface {
	name = 'MigrateEnitity1598380373608';

	public async up(queryRunner: QueryRunner): Promise<void> {
		await queryRunner.query(`ALTER TABLE "base_guild" RENAME COLUMN "memberCount" TO "member_count"`);
	...
	public async down(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(`ALTER TABLE "base_guild" RENAME COLUMN "member_count" TO "memberCount"`);
	}
}
