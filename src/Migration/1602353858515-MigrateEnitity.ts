...
export class MigrateEnitity1602353858515 implements MigrationInterface {
	name = 'MigrateEnitity1602353858515';
	...
	public async down(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(`ALTER TABLE "base_punishment" DROP COLUMN "date"`);
		await queryRunner.query(`ALTER TABLE "base_punishment" ADD "date" TIMESTAMP`);
		await queryRunner.query(`ALTER TABLE "base_member" ALTER COLUMN "money" SET DEFAULT 0`);
