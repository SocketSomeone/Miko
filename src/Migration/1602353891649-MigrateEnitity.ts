...
export class MigrateEnitity1602353891649 implements MigrationInterface {
	name = 'MigrateEnitity1602353891649';
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(`ALTER TABLE "base_punishment" DROP COLUMN "date"`);
		await queryRunner.query(`ALTER TABLE "base_punishment" ADD "date" TIMESTAMP WITH TIME ZONE`);
	...
	public async down(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(`ALTER TABLE "base_punishment" DROP COLUMN "date"`);
		await queryRunner.query(`ALTER TABLE "base_punishment" ADD "date" TIME WITH TIME ZONE`);
		await queryRunner.query(`ALTER TABLE "base_member" ALTER COLUMN "money" SET DEFAULT 0`);
